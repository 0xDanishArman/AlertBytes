...
const Home = ({ account, setAccount, networks }) => {
  ...
  const onSubmit = async () => {
    if (!isAuthenticated) {
      ...
      setloading(true);
      try {
        let selected_alert_method = document.querySelector(
          'input[name="AlertOption"]:checked'
        ).value;
        ...
        <div className="container">
          ...
          >
            <div>
              ...
              <p
                className={styles.title_alertbytes_para}
                style={{ fontWeight: "600" }}
              >
                Monitoring your Wallet/Smart Contract getting difficult?
              </p>
              <p className={styles.title_alertbytes_para_sec}>
                Subscribe to AlertBytes for instant notifications anytime your
                Wallet/Smart Contract triggers an event.
              </p>
            </div>
            ...
            <div className={styles.address_dropdown}>
              ...
              <div className="input-group-append">
                ...
                >
                  <Dropdown.Toggle className="btn-defaults">
            ...
            <div className={styles.address_input} style={{}}>
              <input
                ...
                id="name"
                className="form-control address"
                placeholder="Give a name to your address"
              />
            </div>
            ...
            <div className={styles.condition_box_alert}>
              <div className="row">
                <div className="col-md-5">
                  ...
                  <p className={styles.title_alertmethod_para}>
                    Choose the medium of notification.{" "}
                  </p>
                </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="">
                    ...
                    <p className={styles.title_alertmethod_para}>
                      Set conditions to receive alerts.{" "}
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="">
                    ...
                    <p className={styles.title_alertmethod_para}>
                      Let us know what your alerts should say.
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
